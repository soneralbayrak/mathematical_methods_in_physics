%%% METADATA
\def\publishnote{Originally prepared for \textit{METU - Phys209}}
\def\titlee{Differential Equations in Physics}
\def\authorr{Soner Albayrak}
\def\datee{\today}
\def\abstractt{These are the notes of the lectures prepared for the ``PHYS209 MATHEMATICAL METHODS IN PHYSICS I''  course at \emph{Middle East Technical University}, 2023-2024 Fall Semester ---see\linebreak \hyperref{https://soneralbayrak.com/teaching/Phys209}{}{}{https://soneralbayrak.com/teaching/Phys209}. These notes are mostly based on other sources and I provided the sources in relevant places. Whenever I get the chance, I will keep updating the notes to keep it up-to-date and self-contained; there are also reminders \draftnote{in blue} for me to add further discussion/comments.
